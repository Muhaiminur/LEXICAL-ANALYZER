# LEXICAL-ANALYZER
Problem Description:
Welcome to the LEXICAL-ANALYZER wiki!
# a simple lexical analyzer with java

# Input take
![input picture](https://github.com/Muhaiminur/LEXICAL-ANALYZER/blob/master/input.PNG)

# Output
![output](https://github.com/Muhaiminur/LEXICAL-ANALYZER/blob/master/Output.PNG)
